  ...
  return {
    ...
    MuiRadio: {
      styleOverrides: {
        root: {
          ...
          "&:hover  > span": {
            boxShadow: `0 0 0 3px ${alpha(palette.primary.main, 0.12)} inset`,
          },
        },
      },
    },
      ...
      styleOverrides: {
        root: {
          ...
          "&.Mui-focused": {
            ...
            boxShadow: `${palette.primary.main} 0 0px 0 1px inset`,
          },
          "&.Mui-disabled": {
          ...
          "&.Mui-error": {
            backgroundColor: alpha(palette.error.main, 0.02),
            borderColor: palette.error.main,
            boxShadow: `${alpha(palette.error.main, 0.12)} 0 1px 3px`,
            "&.Mui-focused": {
              backgroundColor: palette.background.paper,
              boxShadow: `${palette.error.main} 0 0px 0 1px inset`,
            },
            "&:hover": {
              backgroundColor: alpha(palette.error.main, 0.02),
              borderColor: palette.error.main,
    ...
    MuiOutlinedInput: {
      styleOverrides: {
        root: {
          ...
          "&.Mui-error": {
            backgroundColor: alpha(palette.error.main, 0.01),
            boxShadow: `${alpha(palette.error.main, 0.12)} 0 1px 3px`,
            "&.Mui-focused": {
              boxShadow: "none",
            },
    ...
    MuiButton: {
      styleOverrides: {
        root: {
          "&.Mui-focusVisible": {
            outline: "solid 2px " + palette.primary.main,
            outlineOffset: 3,
          },
        },
        outlinedSecondary: {
          ...
          boxShadow: `${alpha(palette.secondary.main, 0.08)} 0px 1px 2px 0px`,
          "&:hover": {
          ...
          "&.MuiChip-clickable:hover": {
            ...
            boxShadow: `${alpha(palette.secondary.main, 0.12)} 0px 1px 2px 0px`,
          },
          "&:active": {
            boxShadow: "none",
          },
        ...
        outlinedPrimary: {
          boxShadow: `${alpha(palette.primary.main, 0.12)} 0px 1px 2px 0px`,
          "&.MuiChip-clickable:hover": {
            boxShadow: `${alpha(palette.primary.main, 0.12)} 0px 1px 2px 0px`,
          },
          "&:active": {
